...
CKPT = '../results/isic2017_swinunet_clahe_ftl_k0_SwinUnet_20260730_0001/best.pth'
MODEL_NAME = 'SwinUnet'
...
def main():
    ...
    csv_path = os.path.join(OUT_DIR, 'fold0_train_per_image_dice.csv')
    ...
    bad_csv = os.path.join(OUT_DIR, 'bad_images_fold0.csv')
